...
#define WINDOWSAPPSDK_RUNTIME_VERSION_MAJOR             1002u
#define WINDOWSAPPSDK_RUNTIME_VERSION_MINOR             543u
#define WINDOWSAPPSDK_RUNTIME_VERSION_BUILD             1943u
#define WINDOWSAPPSDK_RUNTIME_VERSION_REVISION          0u
#define WINDOWSAPPSDK_RUNTIME_VERSION_UINT64            0x03EA021F07970000u
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING     "1002.543.1943.0"
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING_W   L"1002.543.1943.0"
...
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X86_PACKAGEFAMILYNAME        "Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x8_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X86_PACKAGEFAMILYNAME_W      L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x8_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X64_PACKAGEFAMILYNAME        "Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X64_PACKAGEFAMILYNAME_W      L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_ARM64_PACKAGEFAMILYNAME      "Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-a6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_ARM64_PACKAGEFAMILYNAME_W    L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-a6_8wekyb3d8bbwe"
...
#define WASR_VERSION_MAJOR              1002
#define WASR_VERSION_MINOR              543
#define WASR_VERSION_BUILD              1943
#define WASR_VERSION_REVISION           0
#define WASR_VERSION_UINT64             0x03EA021F07970000
#define WASR_VERSION_DOTQUADSTRING      "1002.543.1943.0"
#define WASR_VERSION_DOTQUADSTRING_W    L"1002.543.1943.0"
...
#define WASR_PKG_DDLM_X86_FAMILY        "Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x8_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X86_FAMILY_W      L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x8_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X64_FAMILY        "Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X64_FAMILY_W      L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_ARM64_FAMILY      "Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-a6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_ARM64_FAMILY_W    L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-a6_8wekyb3d8bbwe"
#endif
...
namespace Microsoft::WindowsAppSDK
{
    ...
    namespace Runtime
    {
        ...
        namespace Version
        {
            constexpr uint16_t Major = 1002;
            constexpr uint16_t Minor = 543;
            constexpr uint16_t Build = 1943;
            constexpr uint16_t Revision = 0;
            constexpr uint64_t UInt64 = 0x03EA021F07970000;
            constexpr PCWSTR DotQuadString = L"1002.543.1943.0";
        }
        ...
        namespace Packages
        {
            ...
            namespace DDLM
            {
                namespace X86
                {
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x8_8wekyb3d8bbwe";
                }
                namespace X64
                {
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-x6_8wekyb3d8bbwe";
                }
                namespace Arm64
                {
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.1002.543.1943.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
