...
#define WINDOWSAPPSDK_RUNTIME_VERSION_MINOR             447
#define WINDOWSAPPSDK_RUNTIME_VERSION_BUILD             2307
#define WINDOWSAPPSDK_RUNTIME_VERSION_REVISION          0
#define WINDOWSAPPSDK_RUNTIME_VERSION_UINT64            0x03E801BF09030000
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING     "1000.447.2307.0"
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING_W   L"1000.447.2307.0"
...
namespace Microsoft::WindowsAppSDK
{
    ...
    namespace Runtime
    {
        ...
        namespace Version
        {
            ...
            constexpr uint16_t Minor = 447;
            constexpr uint16_t Build = 2307;
            constexpr uint16_t Revision = 0;
            constexpr uint64_t UInt64 = 0x03E801BF09030000;
            constexpr PCWSTR DotQuadString = L"1000.447.2307.0";
        }
