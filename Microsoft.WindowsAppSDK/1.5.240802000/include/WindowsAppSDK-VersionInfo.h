...
#define WINDOWSAPPSDK_RUNTIME_VERSION_MINOR             214u
#define WINDOWSAPPSDK_RUNTIME_VERSION_BUILD             1843u
#define WINDOWSAPPSDK_RUNTIME_VERSION_REVISION          0u
#define WINDOWSAPPSDK_RUNTIME_VERSION_UINT64            0x138900D607330000u
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING     "5001.214.1843.0"
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING_W   L"5001.214.1843.0"
...
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X86_PACKAGEFAMILYNAME        "Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x8_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X86_PACKAGEFAMILYNAME_W      L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x8_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X64_PACKAGEFAMILYNAME        "Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X64_PACKAGEFAMILYNAME_W      L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_ARM64_PACKAGEFAMILYNAME      "Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-a6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_ARM64_PACKAGEFAMILYNAME_W    L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-a6_8wekyb3d8bbwe"
...
#define WASR_VERSION_MINOR              214
#define WASR_VERSION_BUILD              1843
#define WASR_VERSION_REVISION           0
#define WASR_VERSION_UINT64             0x138900D607330000
#define WASR_VERSION_DOTQUADSTRING      "5001.214.1843.0"
#define WASR_VERSION_DOTQUADSTRING_W    L"5001.214.1843.0"
...
#define WASR_PKG_DDLM_X86_FAMILY        "Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x8_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X86_FAMILY_W      L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x8_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X64_FAMILY        "Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X64_FAMILY_W      L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_ARM64_FAMILY      "Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-a6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_ARM64_FAMILY_W    L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-a6_8wekyb3d8bbwe"
#endif
        ...
        namespace Packages
        {
            ...
            namespace DDLM
            {
                namespace X86
                {
                    ...
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x8_8wekyb3d8bbwe";
                }
                namespace X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-x6_8wekyb3d8bbwe";
                }
                namespace Arm64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for arm64.
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.5001.214.1843.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
